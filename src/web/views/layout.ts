...
import { KELLIX_LOGO_MARK_CONTENT, KELLIX_LOGO_VIEWBOX, getKellixBadgeFaviconHref } from "../../brand/logo.js";
  ...
  <nav class="flex items-center justify-between gap-3 mb-8 border-b border-border pb-3">
    <div class="flex items-center gap-3 sm:gap-6 min-w-0">
      <a href="/" class="flex items-center gap-2 flex-shrink-0">
        <svg viewBox="${KELLIX_LOGO_VIEWBOX}" fill="none" class="w-5 h-5 text-neutral-900">${KELLIX_LOGO_MARK_CONTENT}</svg>
...
const faviconHref = getKellixBadgeFaviconHref();
